  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 15px 2px hsl(220 90% 50% / 0.3), 0 0 30px 4px hsl(220 90% 50% / 0.1)" },
          "50%": { boxShadow: "0 0 25px 6px hsl(220 90% 50% / 0.45), 0 0 50px 10px hsl(220 90% 50% / 0.15)" }
        },
        "float": {
